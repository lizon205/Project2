				...
				<ul class="chat">
					...
					<div>
						<div class="header">
							...
							<small class="pull-right text-muted">---- </small><!-- 2018-01-01 13:13 -->
						</div>
						<p>현재 댓글이 없습니다.</p>
						</div>
					</li>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <div class="form-group">
                 	<label>Reply</label>
                 	<input class="form-control" name='reply' id="reply" value='New Reply!!!!'  onkeydown="checkSpacebar()">
                 </div>
                 <div class="form-group">
                 	<label>Replyer</label>
...
// 			showList(1);
	...
	function showReplyPage(replyCnt){
		...
		var str = "<ul class='pagination puul-right'>";
		...
		$.getJSON("/board/getAttachList", {bno: bno}, function(arr){
			...
			$(arr).each(function(i, attach){
				...
				if(attach.fileType){
					...
					str += "<img src='/resources/img/sad.jpg'>";
					str += "</div>";
					str +"</li>";
				}
			});
